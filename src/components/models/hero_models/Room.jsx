...
Performance optimized: removed EffectComposer/SelectiveBloom (very expensive post-processing),
replaced with emissive material + tone mapping for "bloom" effect at near-zero cost.
*/
...
export function Room(props) {
  ...
  // Memoize all materials so they are created once, not re-created every render
  ...
  // Replace SelectiveBloom with emissive material on the screens -
  // much cheaper: no extra render pass needed
  const screenEmissiveMaterial = useMemo(
    () =>
      new THREE.MeshStandardMaterial({
        emissive: new THREE.Color("#00aaff"),
        emissiveIntensity: 2.5,
        toneMapped: false, // bypass tone mapping so it glows
      }),
    []
  );
  ...
  return (
    <group {...props} dispose={null}>
      ...
      {/* Screen mesh - now uses emissive instead of expensive SelectiveBloom */}
      <mesh
        geometry={nodes.emis_lambert1_0.geometry}
        material={screenEmissiveMaterial}
      />
      <mesh
